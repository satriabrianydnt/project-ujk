        ...
        <div class="relative bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('data-barang.store') }}" method="POST">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <label class="block mb-1.5 text-sm font-semibold text-gray-900">Nama Barang</label>
                        <input type="text" name="nama_barang"
                            class="bg-gray-50 border border-gray-300 text-sm rounded-xl block w-full p-2.5 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                            placeholder="Contoh: MacBook Pro" required>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-1.5 text-sm font-semibold text-gray-900">Kode Barang</label>
                            <input type="text" name="kode_barang"
                                class="bg-gray-50 border border-gray-300 text-sm rounded-xl block w-full p-2.5 font-mono outline-none uppercase"
                                placeholder="ELC-001" required>
                        </div>
                        <div>
                            <label class="block mb-1.5 text-sm font-semibold text-gray-900">Kategori</label>
